...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-scene pt-16">
      {/* Grid background */}
      <div
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-scene/60 via-transparent to-scene/80" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-cobalt-600/35 bg-cobalt-600/10 text-accent-hi text-sm font-medium mb-7"
          >
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold font-syne text-ink-1 leading-[1.1] mb-6"
          >
          ...
          <motion.p
            ...
            className="text-ink-3 text-lg leading-relaxed mb-10 max-w-xl"
          >
          ...
          >
            <Link
              href="/cursos"
              className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-gradient-to-r from-cobalt-600 to-cobalt-500 text-white font-semibold rounded-xl hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] transition-all duration-300 hover:-translate-y-0.5 text-base"
            >
            ...
            <Link
              href="/#metodologia"
              className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-transparent border border-cobalt-600/40 text-accent-hi font-semibold rounded-xl hover:bg-cobalt-600/10 hover:border-cobalt-600/70 transition-all duration-300 text-base"
            >
          ...
          >
            {[
              ...
              <div key={i} className="flex items-center gap-1.5">
                {i > 0 && <span className="text-well">|</span>}
                <span className="font-semibold text-ink-1 font-mono">{item.value}</span>
          ...
          {METRIC_CARDS.map((card, i) => (
            ...
            >
              <motion.div
                ...
                className={`bg-surface/90 backdrop-blur-sm border border-cobalt-600/30 rounded-xl p-4 ${
                  i === 1 ? 'ml-10' : i === 3 ? 'ml-6' : ''
                }`}
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <div className="w-7 h-7 rounded-lg bg-cobalt-600/20 flex items-center justify-center">
                      <card.Icon size={14} className={card.color} />
                    </div>
                    <span className="text-ink-3 text-xs font-medium">{card.label}</span>
                  </div>
                  <span
                ...
                <div className="flex items-end justify-between">
                  <span className="text-ink-1 font-bold font-mono text-2xl">{card.value}</span>
