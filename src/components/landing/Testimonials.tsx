...
export default function Testimonials() {
  return (
    <section
      id="testimonios"
      className="py-20 md:py-28 bg-gradient-to-b from-[#030810] to-[#050D1C] relative overflow-hidden"
    >
      {/* Grid background */}
      <div
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {TESTIMONIALS.map((testimonial, i) => (
            ...
            >
              ...
              <div className="absolute top-6 right-6 opacity-15">
                <Quote size={40} className="text-[#2563EB]" />
              </div>
              ...
              {/* Text */}
              <p className="text-[#94A3B8] text-sm leading-relaxed mb-7 relative z-10">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[#E2E8F0] font-semibold text-sm">{testimonial.name}</p>
        ...
        >
          {[
            ...
            <div
              key={stat.label}
              className="bg-[#0A1628]/60 border border-[#2563EB]/10 rounded-xl p-5 text-center"
            >
              <p className="font-bold font-mono text-2xl text-white mb-1">{stat.value}</p>
